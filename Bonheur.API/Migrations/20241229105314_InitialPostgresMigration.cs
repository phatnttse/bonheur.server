        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suppliers_SubscriptionPackages_SubscriptionPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdPackageId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Advertisements_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestPricings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestPricings_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_AverageRating",
                table: "Suppliers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_Discount",
                table: "Suppliers",
                column: "Discount");

            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_District",
                table: "Suppliers",
                column: "District");

            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_IsFeatured",
                table: "Suppliers",
                column: "IsFeatured");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_OnBoardStatus",
                table: "Suppliers",
                column: "OnBoardStatus");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_SubscriptionPackageId",
                table: "Suppliers",
