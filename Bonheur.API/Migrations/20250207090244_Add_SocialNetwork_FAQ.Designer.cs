...
namespace Bonheur.API.Migrations
{
    ...
    [Migration("20250207090244_Add_SocialNetwork_FAQ")]
    partial class Add_SocialNetwork_FAQ
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bonheur.BusinessObjects.Entities.Supplier", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ProrityEnd")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Bonheur.BusinessObjects.Entities.SupplierSocialNetwork", b =>
                {
                    ...
                    b.HasOne("Bonheur.BusinessObjects.Entities.Supplier", "Supplier")
                        .WithMany("SupplierSocialNetworks")
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Bonheur.BusinessObjects.Entities.Supplier", b =>
                {
                    ...
                    b.Navigation("SupplierFAQs");

                    b.Navigation("SupplierSocialNetworks");
                });
