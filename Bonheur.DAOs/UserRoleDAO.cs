...
namespace Bonheur.DAOs
{
    public class UserRoleDAO
    {
        ...
        public UserRoleDAO(ApplicationDbContext context, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
            ...
            IEnumerable<string> claims)
        {
            ...
            {
                var permission = ApplicationPermissions.GetPermissionByValue(claim);
